...
DOWNLOADER_MIDDLEWARES = {
    ...
    'scrapy_fake_useragent.middleware.RandomUserAgentMiddleware': 400,  # scrapy-fake-useragent 随机切换ua
}
...
ITEM_PIPELINES = {
    'scrapy_douban.pipelines.MongoMoviePipeline': False,
    'scrapy_douban.pipelines.ScrapyDoubanMongoPipeline': False,
    'scrapy_douban.pipelines.ScrapyDoubanPipeline': False,
}
